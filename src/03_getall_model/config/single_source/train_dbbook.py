...
if __name__ == "__main__":
    ...
    source_features = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/dbbook/images/user-centroid_item_emb.pkl', 'rb'))).items()))
