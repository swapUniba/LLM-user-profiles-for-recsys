...
if __name__ == "__main__":
    ...
    source_features = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/images/user-centroid_item_emb.pkl', 'rb'))).items()))
    ...
    feature_list = [ ['user-centroid_item_emb'] ]
    getall_models = [GETAllNetworkBasic]    
    dropout_values = [ 0 ]
    setting_names = []
