...
def train(train_ratings: pd.DataFrame, batch_size: int, epochs: int, device: str, model_class: Type[GETAllNetworkMerge],
           modality_features: np.array, weights: list, dropout_value: float):

#Converte il file train_ratings in un dataset PyTorch (GETAllDataset).
...
@torch.no_grad()
def test(model: GETAllNetworkMerge, test_ratings: pd.DataFrame, batch_size: int, device: str, dropout_value: float):
...
if __name__ == "__main__":
    getall_network_class = GETAllNetworkMerge
    ...
    emb_folders = ['C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/dbbook/graph/',
                'C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/dbbook/images/',
                ]
    ...
    feature1 = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/dbbook/graph/compgcn_384_n1.pkl', 'rb'))).items()))
    feature2 = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/dbbook/images/user-centroid_item_emb.pkl', 'rb'))).items()))
    ...
    model = GETAllNetworkMerge(
        modality_features = [text_tensor, image_tensor],  
        dropout_value=0.0 
    ).to(device)


    feature_list = [ ['compgcn_384_n1', 'user-centroid_item_emb'] ]
    getall_models = [GETAllNetworkMerge]    
    dropout_values = [ 0 ]
    setting_names = []
