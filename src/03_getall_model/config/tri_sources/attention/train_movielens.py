...
if __name__ == "__main__":
    ...
    emb_folders = ['C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/images/',
                'C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/text/',
                'C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/graph/',
                ]
    ...
    feature1 = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/images/user-centroid_item_emb.pkl', 'rb'))).items()))
    feature2 = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/text/user-profile_item_emb.pkl', 'rb'))).items()))
    feature3 = dict(sorted((pkl.load(open('C:/Users/arian/Downloads/getall_multimodal_kars-111E/GETAll/data/embeddings/movielens/graph/compgcn_384_n1.pkl', 'rb'))).items()))
