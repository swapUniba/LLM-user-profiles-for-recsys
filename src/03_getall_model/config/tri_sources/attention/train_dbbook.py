...
def train(train_ratings: pd.DataFrame, batch_size: int, epochs: int, device: str, model_class: Type[GETAllNetworkTriSelfSourcesCross],
...
@torch.no_grad()
def test(model: GETAllNetworkTriSelfSourcesCross, test_ratings: pd.DataFrame, batch_size: int, device: str, dropout_value: float):
...
if __name__ == "__main__":
    getall_network_class = GETAllNetworkTriSelfSourcesCross
    ...
    model = GETAllNetworkTriSelfSourcesCross(
